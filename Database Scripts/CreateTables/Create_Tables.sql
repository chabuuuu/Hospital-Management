...
CREATE TABLE THUOC(
    ...
    SUB_ID AS 'MED' + CAST(MATHUOC AS VARCHAR(10)),
    MADONTHUOC INT,
    GHICHU VARCHAR(MAX),
	GIATIEN MONEY,
	DONVITINH NVARCHAR(30),
    CONSTRAINT FK_THUOC_DONTHUOC FOREIGN KEY (MADONTHUOC) REFERENCES DONTHUOC(MADONTHUOC),
)
...
CHECK (LOAITAIKHOAN IN ('Staff', 'Doctor', 'Admin'))



-- Them tai khoan demo
--username: demoAD001 pass: admin123
INSERT INTO TAIKHOAN VALUES('demoAD001', '$MYHASH$V1$10000$Ak57ojfu458lSCWbRNmnF3q+nrjBBLIPiS/Y8GOrrc07po1G', 'AD001', 'Admin', '')
--username: demoST001 pass: staff123
INSERT INTO TAIKHOAN VALUES('demoST001', '$MYHASH$V1$10000$Txfc2EB1HPhTUNkuICzGm01PYzRNzeCDWc0HQQnjRW/E/DpN', 'ST001', 'Staff', '')
--username: demoDR001 pass: doctor123
INSERT INTO TAIKHOAN VALUES('demoDR001', '$MYHASH$V1$10000$RkbDFXtHKsjo2uuPVo+hGkRmoQ2+GH8iDj3o/vUi468mb51z', 'DR001', 'Doctor', '')
...
--Them cot ca lam viec
ALTER TABLE LICHKHAM
ADD CAKHAM INT;

ALTER TABLE LICHKHAM
ADD CONSTRAINT CAKHAM_1_12 CHECK (
	CAKHAM BETWEEN 1 AND 12
)
...
-- KHOA ---
ALTER TABLE KHOA
ALTER COLUMN PICTURE VARCHAR(MAX);
